...
export default function CarroselRecentes() {
  ...
  const recentes = [
    {
      ...
      imagem:
        'https://image-stock.mercuryholidays.co.uk/original/hotel/middle-east/united-arab-emirates/dubai/dubai-city/radisson-blu-hotel-dubai-waterfront/gallery/xxl-608782a_hb_p_001.jpg',
    },
    {
      id: 1,
      icon: 'hotel',
  ...
  return (
    <>
      <View style={styles.carrosel}>
        <Text style={styles.txtCarrosel}>Recentes</Text>
